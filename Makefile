...
help:
	@echo "$(BLUE)Nuagent - Development Commands$(NC)"
	@echo ""
	@echo "$(GREEN)Setup:$(NC)"
...
test-cov:
	...
	pytest $(TEST_DIR) --cov=nuagent --cov-report=html:tests/reports/coverage --cov-report=term-missing --cov-branch
...
lint:
	...
	ruff check $(SRC_DIR)/nuagent $(TEST_DIR)

format:
	@echo "$(BLUE)Formatting code...$(NC)"
	ruff format $(SRC_DIR)/nuagent $(TEST_DIR)
	ruff check --fix $(SRC_DIR)/nuagent $(TEST_DIR)
	@echo "$(GREEN)Code formatted$(NC)"

format-check:
	@echo "$(BLUE)Checking code format...$(NC)"
	ruff format --check $(SRC_DIR)/nuagent $(TEST_DIR)
	ruff check $(SRC_DIR)/nuagent $(TEST_DIR)
...
publish-test: check-dist
	...
	@echo "  pip install --index-url https://test.pypi.org/simple/ nuagent"

publish: check-dist
	@echo "$(YELLOW)Publishing to PyPI (are you sure?)$(NC)"
	@echo "Package: nuagent"
	...
	@echo ""
	@echo "Install with: pip install nuagent"
